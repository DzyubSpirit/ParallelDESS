    ...
    public static void main(String... args) throws Exception{
        ...
        while (num == 0) {
            if (System.currentTimeMillis() - startTime > 1000) {
                SimError err = new SimError();
                err.err = "No input";
                System.out.println(g.toJson(err));
                return;
            }
        ...
        //byte[] bytes = Files.readAllBytes(Paths.get("test.data"));

        NetSimulationData data = g.fromJson(new String(bytes), NetSimulationData.class);
        ...
        System.setOut(out);
        System.out.println(g.toJson(stats));
    }
}
